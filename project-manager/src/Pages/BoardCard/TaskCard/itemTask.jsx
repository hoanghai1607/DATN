...
const ItemCard = (props) => {
  ...
  const handlTaskListMember = (user) => {
    ...
    if (oneMemberTask && oneMemberTask !== null) {
      apiClient
        .fetchApiDeleteTaskUserMenber(
          i.id,
          "fef5731b-9b86-4805-8717-2e01ed217515"
        )
        .then((res) => {
          // console.log(res.data);
        });
    }
    apiClient.fetApiCreateTaskUserMenber(
      i.id,
      "fef5731b-9b86-4805-8717-2e01ed217515"
    );
        ...
        {isShowMember && (
          <div className="list-member-card">
            ...
            <div className="body-list">
              ...
              {memberCard.length > 0 &&
                memberCard.map((item, _i) => (
                  <div
                    className="body-list-member"
                    key={_i}
                    onClick={() => handlTaskListMember(item)}
                  >
